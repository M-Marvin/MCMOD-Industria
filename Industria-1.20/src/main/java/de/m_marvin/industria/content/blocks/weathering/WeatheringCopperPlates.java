...
public interface WeatheringCopperPlates extends WeatheringNonVanilla {
	
	Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(ModBlocks.COPPER_PLATES.get(), ModBlocks.EXPOSED_COPPER_PLATES.get())
				.put(ModBlocks.EXPOSED_COPPER_PLATES.get(), ModBlocks.WEATHERED_COPPER_PLATES.get())
				.put(ModBlocks.WEATHERED_COPPER_PLATES.get(), ModBlocks.OXIDIZED_COPPER_PLATES.get())
				.build();
	});
	...
	Supplier<BiMap<Block, Block>> WAXED_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(ModBlocks.COPPER_PLATES.get(), ModBlocks.WAXED_COPPER_PLATES.get())
				.put(ModBlocks.EXPOSED_COPPER_PLATES.get(), ModBlocks.WAXED_EXPOSED_COPPER_PLATES.get())
				.put(ModBlocks.WEATHERED_COPPER_PLATES.get(), ModBlocks.WAXED_WEATHERED_COPPER_PLATES.get())
				.put(ModBlocks.OXIDIZED_COPPER_PLATES.get(), ModBlocks.WAXED_OXIDIZED_COPPER_PLATES.get())
				.build();
	});
