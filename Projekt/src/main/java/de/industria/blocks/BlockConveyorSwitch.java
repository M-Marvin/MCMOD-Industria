...
public class BlockConveyorSwitch extends BlockContainerBase implements IAdvancedBlockInfo {
	...
	public BlockConveyorSwitch() {
		super("conveyor_switch", Material.IRON, 1.5F, SoundType.LADDER, true);
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		return updateState(context.getWorld(), context.getPos(), this.getDefaultState().with(FACING, context.getPlacementHorizontalFacing()).with(ENABLED, false));
	}
