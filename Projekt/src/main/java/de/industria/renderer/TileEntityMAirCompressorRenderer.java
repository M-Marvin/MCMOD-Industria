...
public class TileEntityMAirCompressorRenderer extends TileEntityRenderer<TileEntityMAirCompressor> {
	...
	public TileEntityMAirCompressorRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
		this.airCompressorModel = new TileEntityMAirCompressorModel();
	}
	
	@Override
	public void render(TileEntityMAirCompressor tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
