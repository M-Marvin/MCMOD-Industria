...
public class BlockFluoriteCrystal extends BlockBase implements IWaterLoggable {
	
	public static final DirectionProperty FACING = BlockStateProperties.FACING;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	
	public BlockFluoriteCrystal() {
		super("fluorite_crystal", Material.STONE, 3F, 2F, SoundType.GLASS);
