...
public class ModTileEntityType {
	...
	public static final TileEntityType<TileEntityHoverControler> HOVER_CONTROLER = register("hover_controler", TileEntityType.Builder.create(TileEntityHoverControler::new, RedTec.radial_conector, Blocks.AIR));
