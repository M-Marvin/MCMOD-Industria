...
public class ModTags {
	...
	private static TagKey<Block> createBlock(String name) {
		return TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(IndustriaCore.MODID, name));
	}
	
	@SuppressWarnings("unused")
	private static TagKey<Item> createItem(String name) {
		return TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(IndustriaCore.MODID, name));
	}
