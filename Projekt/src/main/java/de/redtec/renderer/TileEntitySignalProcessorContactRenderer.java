...
public class TileEntitySignalProcessorContactRenderer extends TileEntityRenderer<TileEntitySignalProcessorContact> {
	...
	@Override
	public void render(TileEntitySignalProcessorContact tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
