...
public class BlockBurnedStairs extends BlockStairsBase {
	...
	public BlockBurnedStairs() {
		super(() -> ModItems.burned_planks.defaultBlockState(), "burned_wood_stairs", Material.WOOD, 1F, 3, SoundType.LADDER);
	...
	public int getDustDropAmount(World world, BlockPos pos, BlockState state) {
		return world.random.nextInt(3) + 1;
	}
