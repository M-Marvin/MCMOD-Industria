...
public static final ResourceLocation SCHREDDER_GUI_TEXTURES = new ResourceLocation(RedTec.MODID, "textures/gui/alloy_furnace.png");
	...
	protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
		...
		this.func_238474_b_(p_230450_1_, i + 64, j + 19, 176, 0, (int) (progress * 49), 46);
		if (te.hasPower) this.func_238474_b_(p_230450_1_, i + 116, j + 53, 176, 46, 16, 16);
