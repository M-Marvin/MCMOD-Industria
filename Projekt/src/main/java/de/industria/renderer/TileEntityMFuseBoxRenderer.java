...
public class TileEntityMFuseBoxRenderer extends TileEntityRenderer<TileEntityMFuseBox> {

	private ItemRenderer itemRenderer;
	
	public TileEntityMFuseBoxRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
	...
	public void render(TileEntityMFuseBox tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
		...
		if (!tileEntityIn.getFuse().isEmpty()) {
			...
			matrixStackIn.pushPose();
				...
				matrixStackIn.scale(0.89F, 0.89F, 0.89F);
				matrixStackIn.translate(3.4F * 0.0625F, 0, -4.5F * 0.0625F);
