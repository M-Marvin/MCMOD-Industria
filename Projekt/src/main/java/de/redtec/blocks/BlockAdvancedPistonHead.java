...
public class BlockAdvancedPistonHead extends DirectionalBlock {
   ...
   private boolean func_235682_a_(BlockState p_235682_1_, BlockState p_235682_2_) {
      Block block = p_235682_1_.get(TYPE) == PistonType.DEFAULT ? RedTec.advanced_piston : RedTec.advanced_sticky_piston;
      return p_235682_2_.isIn(block) && p_235682_2_.get(BlockAdvancedPiston.EXTENDED) && p_235682_2_.get(FACING) == p_235682_1_.get(FACING);
   }
...
public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
   ...
   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
      ...
      return this.func_235682_a_(state, blockstate) || blockstate.isIn(RedTec.advanced_moving_block) && blockstate.get(FACING) == state.get(FACING);
   }
   ...
   public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
      return new ItemStack(state.get(TYPE) == PistonType.STICKY ? RedTec.advanced_sticky_piston : RedTec.advanced_piston);
   }
