...
public class ItemFluidMeter extends ItemBase {
	...
	public ItemFluidMeter() {
		super("fluid_meter", RedTec.MACHINES);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (result.getType() == RayTraceResult.Type.MISS) {
			...
			if (te instanceof IFluidConnective) {
				...
				ITextComponent line = new TranslationTextComponent("redtec.item.fluid_meter.meassure", blockItem.getDisplayName(), fluid.getDisplayName(), fluid.getAmount());
