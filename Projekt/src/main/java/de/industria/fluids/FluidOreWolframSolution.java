...
public abstract class FluidOreWolframSolution extends FlowingFluid {
	...
	public Item getBucket() {
		return ModItems.wolfram_solution_bucket;
	}
	...
	protected BlockState createLegacyBlock(FluidState state) {
		return ModItems.wolfram_solution.defaultBlockState().setValue(BlockModFlowingFluid.LEVEL, getLegacyLevel(state));
	}
	
	@Override
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(
				new ResourceLocation(Industria.MODID, "block/wolfram_solution_still"), 
				new ResourceLocation(Industria.MODID, "block/wolfram_solution_flow"))
					.overlay(new ResourceLocation(Industria.MODID, "block/wolfram_solution_overlay"))
					.build(this);
	}
