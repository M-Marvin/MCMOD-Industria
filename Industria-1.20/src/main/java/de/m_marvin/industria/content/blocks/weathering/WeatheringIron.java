...
public interface WeatheringIron extends WeatheringNonVanilla {
	
	Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(Blocks.IRON_BLOCK, ModBlocks.EXPOSED_IRON_BLOCK.get())
				.put(ModBlocks.EXPOSED_IRON_BLOCK.get(), ModBlocks.WEATHERED_IRON_BLOCK.get())
				.put(ModBlocks.WEATHERED_IRON_BLOCK.get(), ModBlocks.OXIDIZED_IRON_BLOCK.get())
				.put(ModBlocks.IRON_PLATES.get(), ModBlocks.EXPOSED_IRON_PLATES.get())
				.put(ModBlocks.EXPOSED_IRON_PLATES.get(), ModBlocks.WEATHERED_IRON_PLATES.get())
				.put(ModBlocks.WEATHERED_IRON_PLATES.get(), ModBlocks.OXIDIZED_IRON_PLATES.get())
				.build();
	});
	...
	Supplier<BiMap<Block, Block>> WAXED_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(Blocks.IRON_BLOCK, ModBlocks.WAXED_IRON_BLOCK.get())
				.put(ModBlocks.EXPOSED_IRON_BLOCK.get(), ModBlocks.WAXED_EXPOSED_IRON_BLOCK.get())
				.put(ModBlocks.WEATHERED_IRON_BLOCK.get(), ModBlocks.WAXED_WEATHERED_IRON_BLOCK.get())
				.put(ModBlocks.OXIDIZED_IRON_BLOCK.get(), ModBlocks.WAXED_OXIDIZED_IRON_BLOCK.get())
				.put(ModBlocks.IRON_PLATES.get(), ModBlocks.WAXED_IRON_PLATES.get())
				.put(ModBlocks.EXPOSED_IRON_PLATES.get(), ModBlocks.WAXED_EXPOSED_IRON_PLATES.get())
				.put(ModBlocks.WEATHERED_IRON_PLATES.get(), ModBlocks.WAXED_WEATHERED_IRON_PLATES.get())
				.put(ModBlocks.OXIDIZED_IRON_PLATES.get(), ModBlocks.WAXED_OXIDIZED_IRON_PLATES.get())
				.build();
	});
