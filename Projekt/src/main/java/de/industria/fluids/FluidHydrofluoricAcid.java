...
public abstract class FluidHydrofluoricAcid extends FlowingFluid {
	
	@Override
	public Fluid getFlowing() {
		return ModFluids.FLOWING_HYDROFLUORIC_ACID;
	}

	@Override
	public Fluid getSource() {
		return ModFluids.HYDROFLUORIC_ACID;
	}
	...
	public Item getBucket() {
		return ModItems.hydrofluoric_acid_bucket;
	}
	...
	protected BlockState createLegacyBlock(FluidState state) {
		return ModItems.hydrofluoric_acid.defaultBlockState().setValue(BlockModFlowingFluid.LEVEL, getLegacyLevel(state));
	}
	
	@Override
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(
				new ResourceLocation(Industria.MODID, "block/hydrofluoric_acid_still"), 
				new ResourceLocation(Industria.MODID, "block/hydrofluoric_acid_flow"))
					.overlay(new ResourceLocation(Industria.MODID, "block/hydrofluoric_acid_overlay"))
					.build(this);
	}
	
	@Override
	public boolean isSame(Fluid fluidIn) {
		return fluidIn == ModFluids.HYDROFLUORIC_ACID || fluidIn == ModFluids.FLOWING_HYDROFLUORIC_ACID;
	}
	...
	public static class Still extends FluidHydrofluoricAcid {
	...
	public static class Flow extends FluidHydrofluoricAcid {
