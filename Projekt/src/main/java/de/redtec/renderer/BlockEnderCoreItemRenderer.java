...
public class BlockEnderCoreItemRenderer extends ItemStackTileEntityRenderer {
	...
	public static final ResourceLocation ENDER_CORE_TEXTURES = new ResourceLocation(RedTec.MODID, "textures/block/ender_core.png");
	...
	public void func_239207_a_(ItemStack stack, TransformType type, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
		...
		Minecraft.getInstance().getBlockRendererDispatcher().renderBlock(RedTec.ender_core.getDefaultState(), matrixStackIn, bufferIn, combinedLightIn, combinedOverlayIn);
