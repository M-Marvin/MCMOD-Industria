...
public class TileEntityMCoalHeaterModel extends EntityModel<Entity> {
	...
	public TileEntityMCoalHeaterModel() {
		...
		bb_main.setTextureOffset(0, 66).addBox(-21.0F, -15.0F, -5.0F, 26.0F, 9.0F, 26.0F, 0.0F, false);
		bb_main.setTextureOffset(78, 75).addBox(-18.0F, -6.0F, -5.0F, 20.0F, 5.0F, 26.0F, 0.0F, false);
		...
		bb_main.setTextureOffset(96, 33).addBox(-7.0F, -14.0F, -8.0F, 13.0F, 13.0F, 14.0F, 0.0F, false);
		bb_main.setTextureOffset(96, 0).addBox(-22.0F, -14.0F, -8.0F, 13.0F, 13.0F, 14.0F, 0.0F, false);
	}
