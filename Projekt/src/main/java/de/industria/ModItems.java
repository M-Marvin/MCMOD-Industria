...
public class ModItems {
	...
	public static final Block gold_planks_slab = new BlockSlabBase("gold_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block aluminium_planks_slab = new BlockSlabBase("aluminium_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block electrolyt_copper_planks_slab = new BlockSlabBase("electrolyt_copper_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block redstone_alloy_planks_slab = new BlockSlabBase("redstone_alloy_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block silver_planks_slab = new BlockSlabBase("silver_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block palladium_planks_slab = new BlockSlabBase("palladium_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block wolfram_planks_slab = new BlockSlabBase("wolfram_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block nickel_planks_slab = new BlockSlabBase("nickel_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block monel_planks_slab = new BlockSlabBase("monel_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block netherite_planks_slab = new BlockSlabBase("netherite_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_copper_planks_slab = new BlockSlabBase("oxidized_copper_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_tin_planks_slab = new BlockSlabBase("oxidized_tin_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_iron_planks_slab = new BlockSlabBase("oxidized_iron_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_steel_planks_slab = new BlockSlabBase("oxidized_steel_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block weathered_copper_planks_slab = new BlockWeatheringSlab("weathered_copper_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_copper_planks_slab);
	public static final Block weathered_tin_planks_slab = new BlockWeatheringSlab("weathered_tin_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_tin_planks_slab);
	public static final Block weathered_iron_planks_slab = new BlockWeatheringSlab("weathered_iron_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_iron_planks_slab);
	public static final Block weathered_steel_planks_slab = new BlockWeatheringSlab("weathered_steel_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_steel_planks_slab);
	public static final Block exposed_copper_planks_slab = new BlockWeatheringSlab("exposed_copper_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_copper_planks_slab);
	public static final Block exposed_tin_planks_slab = new BlockWeatheringSlab("exposed_tin_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_tin_planks_slab);
	public static final Block exposed_iron_planks_slab = new BlockWeatheringSlab("exposed_iron_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_iron_planks_slab);
	public static final Block exposed_steel_planks_slab = new BlockWeatheringSlab("exposed_steel_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_steel_planks_slab);
	public static final Block tin_planks_slab = new BlockWeatheringSlab("tin_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_tin_planks_slab);
	public static final Block steel_planks_slab = new BlockWeatheringSlab("steel_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_steel_planks_slab);
	public static final Block copper_planks_slab = new BlockWeatheringSlab("copper_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_copper_planks_slab);
	public static final Block iron_planks_slab = new BlockWeatheringSlab("iron_planks_slab", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_iron_planks_slab);
...
//	}
	...
	public static final Block electrolyt_copper_planks_stairs = new BlockStairsBase(() -> electrolyt_copper_planks.getDefaultState(), "electrolyt_copper_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block redstone_alloy_planks_stairs = new BlockStairsBase(() -> redstone_alloy_planks.getDefaultState(), "redstone_alloy_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block silver_planks_stairs = new BlockStairsBase(() -> silver_planks.getDefaultState(), "silver_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block palladium_planks_stairs = new BlockStairsBase(() -> palladium_planks.getDefaultState(), "palladium_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block wolfram_planks_stairs = new BlockStairsBase(() -> wolfram_planks.getDefaultState(), "wolfram_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block nickel_planks_stairs = new BlockStairsBase(() -> nickel_planks.getDefaultState(), "nickel_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block monel_planks_stairs = new BlockStairsBase(() -> monel_planks.getDefaultState(), "monel_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block netherite_planks_stairs = new BlockStairsBase(() -> netherite_planks.getDefaultState(), "netherite_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_copper_planks_stairs = new BlockStairsBase(() -> oxidized_copper_planks.getDefaultState(), "oxidized_copper_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_tin_planks_stairs = new BlockStairsBase(() -> oxidized_tin_planks.getDefaultState(), "oxidized_tin_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_iron_planks_stairs = new BlockStairsBase(() -> oxidized_iron_planks.getDefaultState(), "oxidized_iron_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block oxidized_steel_planks_stairs = new BlockStairsBase(() -> oxidized_steel_planks.getDefaultState(), "oxidized_steel_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE);
	public static final Block weathered_copper_planks_stairs = new BlockWeatheringStairs(() -> weathered_copper_planks.getDefaultState(), "weathered_copper_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_copper_planks_stairs);
	public static final Block weathered_tin_planks_stairs = new BlockWeatheringStairs(() -> weathered_tin_planks.getDefaultState(), "weathered_tin_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_tin_planks_stairs);
	public static final Block weathered_iron_planks_stairs = new BlockWeatheringStairs(() -> weathered_iron_planks.getDefaultState(), "weathered_iron_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_iron_planks_stairs);
	public static final Block weathered_steel_planks_stairs = new BlockWeatheringStairs(() -> weathered_steel_planks.getDefaultState(), "weathered_steel_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, oxidized_steel_planks_stairs);
	public static final Block exposed_copper_planks_stairs = new BlockWeatheringStairs(() -> exposed_copper_planks.getDefaultState(), "exposed_copper_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_copper_planks_stairs);
	public static final Block exposed_tin_planks_stairs = new BlockWeatheringStairs(() -> exposed_tin_planks.getDefaultState(), "exposed_tin_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_tin_planks_stairs);
	public static final Block exposed_iron_planks_stairs = new BlockWeatheringStairs(() -> exposed_iron_planks.getDefaultState(), "exposed_iron_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_iron_planks_stairs);
	public static final Block exposed_steel_planks_stairs = new BlockWeatheringStairs(() -> exposed_steel_planks.getDefaultState(), "exposed_steel_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, weathered_steel_planks_stairs);
	public static final Block tin_planks_stairs = new BlockWeatheringStairs(() -> tin_planks.getDefaultState(), "tin_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_tin_planks_stairs);
	public static final Block steel_planks_stairs = new BlockWeatheringStairs(() -> steel_planks.getDefaultState(), "steel_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_steel_planks_stairs);
	public static final Block copper_planks_stairs = new BlockWeatheringStairs(() -> copper_planks.getDefaultState(), "copper_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_copper_planks_stairs);
	public static final Block iron_planks_stairs = new BlockWeatheringStairs(() -> iron_planks.getDefaultState(), "iron_planks_stairs", Material.ROCK, 2.5F, 3F, SoundType.STONE, exposed_iron_planks_stairs);
	public static final Block white_concrete_stairs = new BlockStairsBase(() -> Blocks.WHITE_CONCRETE.getDefaultState(), "white_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block orange_concrete_stairs = new BlockStairsBase(() -> Blocks.ORANGE_CONCRETE.getDefaultState(), "orange_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block magenta_concrete_stairs = new BlockStairsBase(() -> Blocks.MAGENTA_CONCRETE.getDefaultState(), "magenta_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block light_blue_concrete_stairs = new BlockStairsBase(() -> Blocks.LIGHT_BLUE_CONCRETE.getDefaultState(), "light_blue_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block yellow_concrete_stairs = new BlockStairsBase(() -> Blocks.YELLOW_CONCRETE.getDefaultState(), "yellow_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block lime_concrete_stairs = new BlockStairsBase(() -> Blocks.LIME_CONCRETE.getDefaultState(), "lime_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block pink_concrete_stairs = new BlockStairsBase(() -> Blocks.PINK_CONCRETE.getDefaultState(), "pink_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block gray_concrete_stairs = new BlockStairsBase(() -> Blocks.GRAY_CONCRETE.getDefaultState(), "gray_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block light_gray_concrete_stairs = new BlockStairsBase(() -> Blocks.LIGHT_GRAY_CONCRETE.getDefaultState(), "light_gray_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block cyan_concrete_stairs = new BlockStairsBase(() -> Blocks.CYAN_CONCRETE.getDefaultState(), "cyan_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block purple_concrete_stairs = new BlockStairsBase(() -> Blocks.PURPLE_CONCRETE.getDefaultState(), "purple_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block blue_concrete_stairs = new BlockStairsBase(() -> Blocks.BLUE_CONCRETE.getDefaultState(), "blue_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block brown_concrete_stairs = new BlockStairsBase(() -> Blocks.BROWN_CONCRETE.getDefaultState(), "brown_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block green_concrete_stairs = new BlockStairsBase(() -> Blocks.GREEN_CONCRETE.getDefaultState(), "green_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block red_concrete_stairs = new BlockStairsBase(() -> Blocks.RED_CONCRETE.getDefaultState(), "red_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block black_concrete_stairs = new BlockStairsBase(() -> Blocks.BLACK_CONCRETE.getDefaultState(), "black_concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block white_terracotta_stairs = new BlockStairsBase(() -> Blocks.WHITE_TERRACOTTA.getDefaultState(), "white_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block orange_terracotta_stairs = new BlockStairsBase(() -> Blocks.ORANGE_TERRACOTTA.getDefaultState(), "orange_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block magenta_terracotta_stairs = new BlockStairsBase(() -> Blocks.MAGENTA_TERRACOTTA.getDefaultState(), "magenta_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block light_blue_terracotta_stairs = new BlockStairsBase(() -> Blocks.LIGHT_BLUE_TERRACOTTA.getDefaultState(), "light_blue_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block yellow_terracotta_stairs = new BlockStairsBase(() -> Blocks.YELLOW_TERRACOTTA.getDefaultState(), "yellow_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block lime_terracotta_stairs = new BlockStairsBase(() -> Blocks.LIME_TERRACOTTA.getDefaultState(), "lime_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block pink_terracotta_stairs = new BlockStairsBase(() -> Blocks.PINK_TERRACOTTA.getDefaultState(), "pink_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block gray_terracotta_stairs = new BlockStairsBase(() -> Blocks.GRAY_TERRACOTTA.getDefaultState(), "gray_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block light_gray_terracotta_stairs = new BlockStairsBase(() -> Blocks.LIGHT_GRAY_TERRACOTTA.getDefaultState(), "light_gray_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block cyan_terracotta_stairs = new BlockStairsBase(() -> Blocks.CYAN_TERRACOTTA.getDefaultState(), "cyan_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block purple_terracotta_stairs = new BlockStairsBase(() -> Blocks.PURPLE_TERRACOTTA.getDefaultState(), "purple_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block blue_terracotta_stairs = new BlockStairsBase(() -> Blocks.BLUE_TERRACOTTA.getDefaultState(), "blue_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block brown_terracotta_stairs = new BlockStairsBase(() -> Blocks.BROWN_TERRACOTTA.getDefaultState(), "brown_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block green_terracotta_stairs = new BlockStairsBase(() -> Blocks.GREEN_TERRACOTTA.getDefaultState(), "green_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block red_terracotta_stairs = new BlockStairsBase(() -> Blocks.RED_TERRACOTTA.getDefaultState(), "red_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block black_terracotta_stairs = new BlockStairsBase(() -> Blocks.BLACK_TERRACOTTA.getDefaultState(), "black_terracotta_stairs", Material.ROCK, 2,3, SoundType.STONE);
	public static final Block white_painted_planks_stairs = new BlockBurnableStairs(() -> white_painted_planks.getDefaultState(), "white_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block orange_painted_planks_stairs = new BlockBurnableStairs(() -> orange_painted_planks.getDefaultState(), "orange_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block magenta_painted_planks_stairs = new BlockBurnableStairs(() -> magenta_painted_planks.getDefaultState(), "magenta_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block light_blue_painted_planks_stairs = new BlockBurnableStairs(() -> light_blue_painted_planks.getDefaultState(), "light_blue_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block yellow_painted_planks_stairs = new BlockBurnableStairs(() -> yellow_painted_planks.getDefaultState(), "yellow_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block lime_painted_planks_stairs = new BlockBurnableStairs(() -> lime_painted_planks.getDefaultState(), "lime_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block pink_painted_planks_stairs = new BlockBurnableStairs(() -> pink_painted_planks.getDefaultState(), "pink_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block gray_painted_planks_stairs = new BlockBurnableStairs(() -> gray_painted_planks.getDefaultState(), "gray_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block light_gray_painted_planks_stairs = new BlockBurnableStairs(() -> light_gray_painted_planks.getDefaultState(), "light_gray_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block cyan_painted_planks_stairs = new BlockBurnableStairs(() -> cyan_painted_planks.getDefaultState(), "cyan_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block purple_painted_planks_stairs = new BlockBurnableStairs(() -> purple_painted_planks.getDefaultState(), "purple_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block blue_painted_planks_stairs = new BlockBurnableStairs(() -> blue_painted_planks.getDefaultState(), "blue_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block brown_painted_planks_stairs = new BlockBurnableStairs(() -> brown_painted_planks.getDefaultState(), "brown_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block green_painted_planks_stairs = new BlockBurnableStairs(() -> green_painted_planks.getDefaultState(), "green_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block red_painted_planks_stairs = new BlockBurnableStairs(() -> red_painted_planks.getDefaultState(), "red_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block black_painted_planks_stairs = new BlockBurnableStairs(() -> black_painted_planks.getDefaultState(), "black_painted_planks_stairs", Material.WOOD, 2, 3, SoundType.WOOD, 5, 20, 300 , true);
	public static final Block concrete_stairs = new BlockStairsBase(() -> concrete.getDefaultState(), "concrete_stairs", Material.ROCK, 1.8F, SoundType.STONE);
	public static final Block cracked_blue_nether_brick_stairs = new BlockStairsBase(() -> cracked_blue_nether_bricks.getDefaultState(), "cracked_blue_nether_brick_stairs", Material.ROCK, 2, 6, SoundType.NETHER_BRICK);
	public static final Block cracked_nether_brick_stairs = new BlockStairsBase(() -> Blocks.CRACKED_NETHER_BRICKS.getDefaultState(), "cracked_nether_brick_stairs", Material.ROCK, 2, 6, SoundType.NETHER_BRICK);
	public static final Block cracked_red_nether_brick_stairs = new BlockStairsBase(() -> cracked_red_nether_bricks.getDefaultState(), "cracked_red_nether_brick_stairs", Material.ROCK, 2, 6, SoundType.NETHER_BRICK);
	public static final Block cracked_andesite_brick_stairs = new BlockStairsBase(() -> cracked_polished_andesite_bricks.getDefaultState(), "cracked_andesite_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_diorite_brick_stairs = new BlockStairsBase(() -> cracked_polished_diorite_bricks.getDefaultState(), "cracked_diorite_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_granite_brick_stairs = new BlockStairsBase(() -> cracked_polished_granite_bricks.getDefaultState(), "cracked_granite_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_bauxite_brick_stairs = new BlockStairsBase(() -> cracked_polished_bauxite_bricks.getDefaultState(), "cracked_bauxite_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_wolframite_brick_stairs = new BlockStairsBase(() -> cracked_polished_wolframite_bricks.getDefaultState(), "cracked_wolframite_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_brick_stairs = new BlockStairsBase(() -> cracked_bricks.getDefaultState(), "cracked_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_sandstone_brick_stairs = new BlockStairsBase(() -> cracked_polished_sandstone_bricks.getDefaultState(), "cracked_sandstone_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_red_sandstone_brick_stairs = new BlockStairsBase(() -> cracked_polished_red_sandstone_bricks.getDefaultState(), "cracked_red_sandstone_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_stone_brick_stairs = new BlockStairsBase(() -> Blocks.CRACKED_STONE_BRICKS.getDefaultState(), "cracked_stone_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_blackstone_brick_stairs = new BlockStairsBase(() -> Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS.getDefaultState(), "cracked_blackstone_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_prismarine_brick_stairs = new BlockStairsBase(() -> cracked_prismarine_bricks.getDefaultState(), "cracked_prismarine_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_quartz_brick_stairs = new BlockStairsBase(() -> cracked_quartz_bricks.getDefaultState(), "cracked_quartz_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block cracked_end_stone_brick_stairs = new BlockStairsBase(() -> cracked_end_stone_bricks.getDefaultState(), "cracked_end_stone_brick_stairs", Material.ROCK, 3, 9, SoundType.STONE);
	public static final Block netherrack_stairs = new BlockStairsBase(() -> Blocks.NETHERRACK.getDefaultState(), "netherrack_stairs", Material.ROCK, 0.4F, SoundType.NETHERRACK);
	public static final Block end_stone_stairs = new BlockStairsBase(() -> Blocks.END_STONE.getDefaultState(), "end_stone_stairs", Material.ROCK, 3, 9, SoundType.STONE);
	public static final Block bauxite_stairs = new BlockStairsBase(() -> bauxite.getDefaultState(), "bauxite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block wolframite_stairs = new BlockStairsBase(() -> wolframite.getDefaultState(), "wolframite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block salt_stairs = new BlockStairsBase(() -> salt_block.getDefaultState(), "salt_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block blue_nether_brick_stairs = new BlockStairsBase(() -> blue_nether_bricks.getDefaultState(), "blue_nether_brick_stairs", Material.ROCK, 2, 6, SoundType.NETHER_BRICK);
	public static final Block quartz_brick_stairs = new BlockStairsBase(() -> Blocks.QUARTZ_BRICKS.getDefaultState(), "quartz_brick_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block diorite_brick_stairs = new BlockStairsBase(() -> polished_diorite_bricks.getDefaultState(), "diorite_brick_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block granite_brick_stairs = new BlockStairsBase(() -> polished_granite_bricks.getDefaultState(), "granite_brick_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block andesite_brick_stairs = new BlockStairsBase(() -> polished_andesite_bricks.getDefaultState(), "andesite_brick_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block bauxite_brick_stairs = new BlockStairsBase(() -> polished_bauxite_bricks.getDefaultState(), "bauxite_brick_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block wolframite_brick_stairs = new BlockStairsBase(() -> polished_wolframite_bricks.getDefaultState(), "wolframite_brick_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	...
	public static final Block polished_prismarine_stairs = new BlockStairsBase(() -> polished_prismarine.getDefaultState(), "polished_prismarine_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block polished_dark_prismarine_stairs = new BlockStairsBase(() -> polished_dark_prismarine.getDefaultState(), "polished_dark_prismarine_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block polished_stone_stairs = new BlockStairsBase(() -> polished_stone.getDefaultState(), "polished_stone_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block polished_bauxite_stairs = new BlockStairsBase(() -> polished_bauxite.getDefaultState(), "polished_bauxite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block polished_wolframite_stairs = new BlockStairsBase(() -> polished_wolframite.getDefaultState(), "polished_wolframite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block mossy_end_stone_brick_stairs = new BlockStairsBase(() -> mossy_end_stone_bricks.getDefaultState(), "mossy_end_stone_brick_stairs", Material.ROCK, 3, 9, SoundType.STONE);
	public static final Block blackstone_tiles_stairs = new BlockStairsBase(() -> blackstone_tiles.getDefaultState(), "blackstone_tiles_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block quartz_tiles_stairs = new BlockStairsBase(() -> quartz_tiles.getDefaultState(), "quartz_tiles_stairs", Material.ROCK, 2, 6, SoundType.STONE);
	public static final Block diorite_tiles_stairs = new BlockStairsBase(() -> diorite_tiles.getDefaultState(), "diorite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block granite_tiles_stairs = new BlockStairsBase(() -> granite_tiles.getDefaultState(), "granite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block andesite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "andesite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block stone_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "stone_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block bauxite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "bauxite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block wolframite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "wolframite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block smooth_diorite_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "smooth_diorite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block smooth_granite_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "smooth_granite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block smooth_andesite_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "smooth_andesite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block smooth_bauxite_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "smooth_bauxite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block smooth_wolframite_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "smooth_wolframite_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block cracked_blackstone_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_blackstone_tiles_stairs", Material.ROCK, 2F, 6, SoundType.STONE);
	public static final Block cracked_quartz_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_quartz_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block cracked_diorite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_diorite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block cracked_granite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_granite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block cracked_andesite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_andesite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block cracked_stone_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_stone_tiles_stairs", Material.ROCK, 2F, 6, SoundType.STONE);
	public static final Block cracked_bauxite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_bauxite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block cracked_wolframite_tiles_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "cracked_wolframite_tiles_stairs", Material.ROCK, 1.5F, 6, SoundType.STONE);
	public static final Block red_sandstone_brick_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "red_sandstone_brick_stairs", Material.ROCK, 2F, 6, SoundType.STONE);
	public static final Block sandstone_brick_stairs = new BlockStairsBase(() -> gold_planks.getDefaultState(), "sandstone_brick_stairs", Material.ROCK, 2F, 6, SoundType.STONE);
