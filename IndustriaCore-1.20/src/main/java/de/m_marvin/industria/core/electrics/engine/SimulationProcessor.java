...
//		}
	...
	private void writeInitFile() {
		...
		try {
			...
			InputStream spinitFileIn = IndustriaCore.ARCHIVE_ACCESS.open("spiceinit/spinit");
		...
		for (String module : spiceModules) {
			...
			try {
				...
				InputStream moduleIn = IndustriaCore.ARCHIVE_ACCESS.open("spiceinit/codemodels/" + module);
