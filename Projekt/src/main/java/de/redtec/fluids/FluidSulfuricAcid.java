...
public abstract class FluidSulfuricAcid extends FlowingFluid {
	...
	public Item getFilledBucket() {
		return RedTec.sulfuric_acid_bucket;
	}
	...
	protected BlockState getBlockState(FluidState state) {
		return RedTec.sulfuric_acid.getDefaultState().with(BlockModFlowingFluid.LEVEL, getLevelFromState(state));
	}
	
	@Override
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(
				new ResourceLocation(RedTec.MODID, "block/sulfuric_acid_still"), 
				new ResourceLocation(RedTec.MODID, "block/sulfuric_acid_flow"))
					.overlay(new ResourceLocation(RedTec.MODID, "block/sulfuric_acid_overlay"))
					.build(this);
	}
