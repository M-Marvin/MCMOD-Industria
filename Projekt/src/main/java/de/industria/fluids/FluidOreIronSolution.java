...
public abstract class FluidOreIronSolution extends FlowingFluid {
	...
	public Item getBucket() {
		return ModItems.iron_solution_bucket;
	}
	...
	protected BlockState createLegacyBlock(FluidState state) {
		return ModItems.iron_solution.defaultBlockState().setValue(BlockModFlowingFluid.LEVEL, getLegacyLevel(state));
	}
	
	@Override
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(
				new ResourceLocation(Industria.MODID, "block/iron_solution_still"), 
				new ResourceLocation(Industria.MODID, "block/iron_solution_flow"))
					.overlay(new ResourceLocation(Industria.MODID, "block/iron_solution_overlay"))
					.build(this);
	}
