...
public interface WeatheringSteel extends WeatheringNonVanilla {
	
	Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(ModBlocks.STEEL_BLOCK.get(), ModBlocks.EXPOSED_STEEL_BLOCK.get())
				.put(ModBlocks.EXPOSED_STEEL_BLOCK.get(), ModBlocks.WEATHERED_STEEL_BLOCK.get())
				.put(ModBlocks.WEATHERED_STEEL_BLOCK.get(), ModBlocks.OXIDIZED_STEEL_BLOCK.get())
				.put(ModBlocks.STEEL_PLATES.get(), ModBlocks.EXPOSED_STEEL_PLATES.get())
				.put(ModBlocks.EXPOSED_STEEL_PLATES.get(), ModBlocks.WEATHERED_STEEL_PLATES.get())
				.put(ModBlocks.WEATHERED_STEEL_PLATES.get(), ModBlocks.OXIDIZED_STEEL_PLATES.get())
				.build();
	});
	...
	Supplier<BiMap<Block, Block>> WAXED_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(ModBlocks.STEEL_BLOCK.get(), ModBlocks.WAXED_STEEL_BLOCK.get())
				.put(ModBlocks.EXPOSED_STEEL_BLOCK.get(), ModBlocks.WAXED_EXPOSED_STEEL_BLOCK.get())
				.put(ModBlocks.WEATHERED_STEEL_BLOCK.get(), ModBlocks.WAXED_WEATHERED_STEEL_BLOCK.get())
				.put(ModBlocks.OXIDIZED_STEEL_BLOCK.get(), ModBlocks.WAXED_OXIDIZED_STEEL_BLOCK.get())
				.put(ModBlocks.STEEL_PLATES.get(), ModBlocks.WAXED_STEEL_PLATES.get())
				.put(ModBlocks.EXPOSED_STEEL_PLATES.get(), ModBlocks.WAXED_EXPOSED_STEEL_PLATES.get())
				.put(ModBlocks.WEATHERED_STEEL_PLATES.get(), ModBlocks.WAXED_WEATHERED_STEEL_PLATES.get())
				.put(ModBlocks.OXIDIZED_STEEL_PLATES.get(), ModBlocks.WAXED_OXIDIZED_STEEL_PLATES.get())
				.build();
	});
