...
public abstract class FluidChemicalWater extends FlowingFluid {
	...
	public Item getBucket() {
		return ModItems.chemical_water_bucket;
	}
	...
	protected BlockState createLegacyBlock(FluidState state) {
		return ModItems.chemical_water.defaultBlockState().setValue(BlockModFlowingFluid.LEVEL, getLegacyLevel(state));
	}
	
	@Override
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(
				new ResourceLocation(Industria.MODID, "block/chemical_water_still"), 
				new ResourceLocation(Industria.MODID, "block/chemical_water_flow"))
					.overlay(new ResourceLocation(Industria.MODID, "block/chemical_water_overlay"))
					.build(this);
	}
