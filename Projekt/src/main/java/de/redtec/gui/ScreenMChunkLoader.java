...
public class ScreenMChunkLoader extends ContainerScreen<ContainerMChunkLoader> {
	...
	public static final ResourceLocation CHUNK_LOADER_GUI_TEXTURES = new ResourceLocation(RedTec.MODID, "textures/gui/chunk_loader.png");
	...
	public void onSelctionChanged() {
		RedTec.NETWORK.sendToServer(new CUpdateChunkLoader(this.container.getTileEntity().getPos(), this.container.getTileEntity().activeRelativeChunks));
	}
