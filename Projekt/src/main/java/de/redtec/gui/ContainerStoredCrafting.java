...
public class ContainerStoredCrafting extends ContainerTileEntity<TileEntityStoringCraftingTable> {

	public ContainerStoredCrafting(int id, PlayerInventory playerInv, PacketBuffer data) {
		super(ModContainerType.STORED_CRAFTING, id, playerInv, data);
	}

	public ContainerStoredCrafting(int id, PlayerInventory playerInv, TileEntityStoringCraftingTable tileEntity) {
