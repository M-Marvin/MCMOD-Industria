...
public static final ResourceLocation COAL_HEATER_GUI_TEXTURES = new ResourceLocation(RedTec.MODID, "textures/gui/electric_furnace.png");
	...
	protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
		...
		this.func_238474_b_(p_230450_1_, i + 79, j + 34, 176, 0, (int) (progress * 24), 16);
		if (te.hasPower) this.func_238474_b_(p_230450_1_, i + 56, j + 53, 176, 17, 16, 16);
