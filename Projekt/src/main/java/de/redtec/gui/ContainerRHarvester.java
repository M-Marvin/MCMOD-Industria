...
public class ContainerRHarvester extends ContainerTileEntity<TileEntityRHarvester> {
	
	public ContainerRHarvester(int id, PlayerInventory playerInv, PacketBuffer data) {
		super(ModContainerType.HARVESTER, id, playerInv, data);
	}
	
	public ContainerRHarvester(int id, PlayerInventory playerInv, TileEntityRHarvester tileEntity) {
