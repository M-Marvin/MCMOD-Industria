...
public class ContainerRHoverControler extends ContainerTileEntity<TileEntityRHoverControler> {

	public ContainerRHoverControler(int id, PlayerInventory playerInv, TileEntityRHoverControler tileEntity) {
		super(ModContainerType.HOVER_CONTROLER, id, playerInv, tileEntity);
	}

	public ContainerRHoverControler(int id, PlayerInventory playerInv, PacketBuffer data) {
