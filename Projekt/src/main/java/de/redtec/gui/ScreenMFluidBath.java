...
public class ScreenMFluidBath extends ContainerScreen<ContainerMFluidBath> {
	...
	protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
		...
		this.field_230706_i_.getTextureManager().bindTexture(FLUID_BATH_GUI_TEXTURES);
		int i = this.guiLeft;
		...
		this.func_238474_b_(p_230450_1_, i + 53, j + 15, 176, 16, (int) (progress * 71), 16);
		this.func_238474_b_(p_230450_1_, i + 58, j + 60, 176, 33, (int) (fluidDurabillity * 52), 6);
		...
		if (this.container.getTileEntity().fluidBufferState > 0 && this.container.getTileEntity().lastRecipe != null) {
			FluidBarTexture.drawFluidTexture(p_230450_1_, this, this.container.getTileEntity().lastRecipe.getFluidIn().getFluid(), i + 50, j + 55, 52, 29, 40 + (int) (240F * this.container.getTileEntity().fluidBufferState));
			FluidBarTexture.drawFluidTexture(p_230450_1_, this, this.container.getTileEntity().lastRecipe.getFluidIn().getFluid(), i + 50, j + 21, 52, 6, 40 + (int) (240F * this.container.getTileEntity().fluidBufferState));
		}
