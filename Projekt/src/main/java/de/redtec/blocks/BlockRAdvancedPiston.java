   ...
   private boolean doMove(World worldIn, BlockPos pos, Direction directionIn, boolean extending) {
      ...
      if (!pistonblockstructurehelper.canMove()) {
         ...
         if (extending) {
            ...
            BlockState blockstate4 = RedTec.advanced_piston_head.getDefaultState().with(BlockRAdvancedPistonHead.FACING, directionIn).with(BlockRAdvancedPistonHead.TYPE, pistontype);
