...
public static final ResourceLocation THERMAL_ZENTRIFUGE_GUI_TEXTURES = new ResourceLocation(RedTec.MODID, "textures/gui/thermal_zentrifuge.png");
	...
	protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
		...
		this.field_230706_i_.getTextureManager().bindTexture(THERMAL_ZENTRIFUGE_GUI_TEXTURES);
		int i = this.guiLeft;
		...
		this.func_238474_b_(p_230450_1_, i + 62, j + 13, 176, 0, (int) (progress * 51), 59);
		this.func_238474_b_(p_230450_1_, i + 62, j + 72, 176, 59, (int) (te.temp * 51), 6);
		if (te.hasPower) this.func_238474_b_(p_230450_1_, i + 44, j + 53, 176, 65, 16, 16);
