...
import de.industria.worldgen.placements.NextTopSurfacePlacement;
...
import de.industria.worldgen.placements.VerticalSpreadPlacement;
...
public class ModPlacement {
	...
	public static final Placement<VerticalSpreadPlacementConfig> VERTICAL_SPREAD = register(new ResourceLocation(Industria.MODID, "vertical_spread"), new VerticalSpreadPlacement(VerticalSpreadPlacementConfig.CODEC));
	...
	public static final Placement<NoPlacementConfig> NEXT_TOP_SURFACE = register(new ResourceLocation(Industria.MODID, "next_top_surface"), new NextTopSurfacePlacement(NoPlacementConfig.CODEC));
