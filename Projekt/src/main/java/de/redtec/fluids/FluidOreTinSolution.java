...
public abstract class FluidOreTinSolution extends FlowingFluid {
	...
	public Item getFilledBucket() {
		return RedTec.tin_solution_bucket;
	}
	...
	protected BlockState getBlockState(FluidState state) {
		return RedTec.tin_solution.getDefaultState().with(BlockModFlowingFluid.LEVEL, getLevelFromState(state));
	}
	
	@Override
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(
				new ResourceLocation(RedTec.MODID, "block/tin_solution_still"), 
				new ResourceLocation(RedTec.MODID, "block/tin_solution_flow"))
					.overlay(new ResourceLocation(RedTec.MODID, "block/tin_solution_overlay"))
					.build(this);
	}
