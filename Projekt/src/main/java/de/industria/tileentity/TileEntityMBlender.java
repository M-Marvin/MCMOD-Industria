...
public class TileEntityMBlender extends TileEntityInventoryBase implements ITickableTileEntity, ITESimpleMachineSound, ISidedInventory, INamedContainerProvider, ITEFluidConnective {
