...
public class TileEntityAdvancedMovingBlock extends TileEntity implements ITickableTileEntity {
   ...
   public void clearPistonTileEntity() {
      if (this.world != null && (this.lastProgress < 1.0F || this.world.isRemote)) {
         ...
         this.remove();
         if (this.world.getBlockState(this.pos).isIn(RedTec.advanced_moving_block)) {
   ...
   public void tick() {
      ...
      if (this.lastProgress >= 1.0F) {
         if (this.world.isRemote && this.field_242697_l < 5) {
            ...
            if (this.pistonState != null && this.world.getBlockState(this.pos).isIn(RedTec.advanced_moving_block)) {
               ...
               if (blockstate.isAir()) {
                  ...
                  if (blockstate.isValidPosition(world, this.pos)) {
                      ...
                      this.world.notifyNeighborsOfStateChange(pos, blockstate.getBlock());
                      this.world.neighborChanged(this.pos, blockstate.getBlock(), this.pos);
