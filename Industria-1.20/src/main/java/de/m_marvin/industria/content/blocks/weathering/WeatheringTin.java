...
public interface WeatheringTin extends WeatheringNonVanilla {
	
	Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(ModBlocks.TIN_BLOCK.get(), ModBlocks.EXPOSED_TIN_BLOCK.get())
				.put(ModBlocks.EXPOSED_TIN_BLOCK.get(), ModBlocks.WEATHERED_TIN_BLOCK.get())
				.put(ModBlocks.WEATHERED_TIN_BLOCK.get(), ModBlocks.OXIDIZED_TIN_BLOCK.get())
				.put(ModBlocks.TIN_PLATES.get(), ModBlocks.EXPOSED_TIN_PLATES.get())
				.put(ModBlocks.EXPOSED_TIN_PLATES.get(), ModBlocks.WEATHERED_TIN_PLATES.get())
				.put(ModBlocks.WEATHERED_TIN_PLATES.get(), ModBlocks.OXIDIZED_TIN_PLATES.get())
				.build();
	});
	...
	Supplier<BiMap<Block, Block>> WAXED_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				.put(ModBlocks.TIN_BLOCK.get(), ModBlocks.WAXED_TIN_BLOCK.get())
				.put(ModBlocks.EXPOSED_TIN_BLOCK.get(), ModBlocks.WAXED_EXPOSED_TIN_BLOCK.get())
				.put(ModBlocks.WEATHERED_TIN_BLOCK.get(), ModBlocks.WAXED_WEATHERED_TIN_BLOCK.get())
				.put(ModBlocks.OXIDIZED_TIN_BLOCK.get(), ModBlocks.WAXED_OXIDIZED_TIN_BLOCK.get())
				.put(ModBlocks.TIN_PLATES.get(), ModBlocks.WAXED_TIN_PLATES.get())
				.put(ModBlocks.EXPOSED_TIN_PLATES.get(), ModBlocks.WAXED_EXPOSED_TIN_PLATES.get())
				.put(ModBlocks.WEATHERED_TIN_PLATES.get(), ModBlocks.WAXED_WEATHERED_TIN_PLATES.get())
				.put(ModBlocks.OXIDIZED_TIN_PLATES.get(), ModBlocks.WAXED_OXIDIZED_TIN_PLATES.get())
				.build();
	});
